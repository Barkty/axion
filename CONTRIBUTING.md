...
Look for the project's contribution instructions. If there are any, follow them.

- Clone the repo on your local machine. Your remote repo on Github is called `origin`.
...
- From your branch, open a pull request in the correct branch. Target the project's `dev` branch if there is one, else go for `staging`!
- ...
- Once the pull request is approved and merged you can pull the changes from `origin` to your local repo and delete
...
Congratulations :tada::tada: The Soar team thanks you :sparkles:. 
